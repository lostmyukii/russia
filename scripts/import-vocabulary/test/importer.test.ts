...
describe('vocabulary CSV importer', () => {
  it('dry-runs PEP textbook vocabulary rows and reports grouped unit counts', () => {
    const csv = [
      ...
      'pep,人教版授权版本,pep-ru-junior-g7-full,1,第 1 单元,1,школа,шко́ла,noun,学校,feminine,,,Это моя школа.,这是我的学校。,,人教版授权教材词表',
      'pep,人教版授权版本,pep-ru-junior-g7-full,1,第 1 单元,1,класс,класс,noun,班级;教室,masculine,,,Это наш класс.,这是我们的教室。,,人教版授权教材词表',
    ].join('\n')
